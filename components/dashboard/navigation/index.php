<nav>
    <div class="logo">
        <img src="./img/pmo-logo.png" alt="PMO LOGO" width="100" height="100">
    </div>
    <div class="navigation">
        <ul>
            ...
            <li><button id="historyBtn" class="btn btn-link" onclick="showContent('history')" title="History"><i
                        class="material-icons icon-lg icon-white">history</i></button></li>
        </ul>
    </div>
</nav>